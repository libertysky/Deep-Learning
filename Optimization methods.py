...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        parameters["W" + str(l+1)] = parameters["b" + str(l+1)]-learning_rate* v_corrected["dW" + str(l+1)]/(np.sqrt(s_corrected["dW" + str(l+1)])-epsilon)
...
# 
# Lets use the following "moons" dataset to test the different optimization methods. (The dataset is named "moons" because 
# the data from each of the two classes looks a bit like a crescent-shaped moon.) 
